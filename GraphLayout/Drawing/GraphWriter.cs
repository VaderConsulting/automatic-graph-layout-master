...
namespace Microsoft.Msagl.Drawing {
    ...
    public class GraphWriter {
        ...
        void WriteSubgraph(Subgraph subgraph) {
            ...
            WriteNodeAttribute(subgraph.Attribute);
        ...
        private void WriteGraphAttribute(GraphAttribute graphAttr) {
            WriteStartElement(Tokens.GraphAttribute);
            WriteBaseAttribute(graphAttr);
            WriteMinNodeHeight();
            WriteMinNodeWidth();
            WriteAspectRatio();
            WriteBorder();
        ...
        private void WriteEdge(Edge edge) {
            ...
            WriteEdgeAttribute(edge.Attribute);
            WriteLabel(edge.Label);
            WriteEndElement();
        }

        private void WriteEdgeAttribute(EdgeAttribute edgeAttr) {
            WriteStartElement(Tokens.EdgeAttribute);
            WriteBaseAttribute(edgeAttr);
        ...
        private void WriteNode(Node node) {
            ...
            WriteNodeAttribute(node.Attribute);
            WriteLabel(node.Label);
            WriteEndElement();
        }

        private void WriteNodeAttribute(NodeAttribute na) {
            WriteStartElement(Tokens.NodeAttribute);
            WriteBaseAttribute(na);
        ...
        private void WriteBaseAttribute(AttributeBase baseAttr) {
