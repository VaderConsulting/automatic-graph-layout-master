...
/// </summary>
        override public Rectangle BoundingBox {
            get {
                ...
                if (this.attribute.ArrowAtTarget)
                    bb.Add(ArrowAtTargetPosition);

                if (this.attribute.ArrowAtSource)
        ...
        /// The edge attribute.
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Attribute")]
        ...
        public Edge(string source, string labelText, string target) {
            ...
            this.attribute = new EdgeAttribute();
