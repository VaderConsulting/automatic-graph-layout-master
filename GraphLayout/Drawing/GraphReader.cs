...
namespace Microsoft.Msagl.Drawing {
    ...
    public class GraphReader {
        ...
        private void ReadEdge() {
            ...
            edge.Attribute = new EdgeAttribute();
            edge.UserData = userData;
            ReadEdgeAttribute(edge.Attribute);
            ReadLabel(edge);
            EdgeList.Add(edge);
            ReadEndElement();
        }
        ...
        private void ReadEdgeAttribute(EdgeAttribute edgeAttr) {
            CheckToken(Tokens.EdgeAttribute);
            XmlRead();
            ReadBaseAttribute(edgeAttr);
        ...
        Subgraph ReadSubgraphContent()
        {
            ...
            ReadNodeAttribute(NodeAttribute);
            var subgraph = new Subgraph(NodeAttribute.Id) {Label = null, Attribute = NodeAttribute, UserData = userData};
            ReadLabel(subgraph);
            ReadEndElement();
            return subgraph;
        }
        ...
        void ReadNodeContent() {
            ...
            var NodeAttribute = new NodeAttribute();
            ReadNodeAttribute(NodeAttribute);
            var node = graph.AddNode(NodeAttribute.Id);
            node.Label = null;
        ...
        private void ReadNodeAttribute(NodeAttribute na) {
            CheckToken(Tokens.NodeAttribute); 
            XmlRead();
            ReadBaseAttribute(na);
        ...
        private void ReadBaseAttribute(AttributeBase baseAttr) {
