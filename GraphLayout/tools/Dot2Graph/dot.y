...
%%   
    ...
    void MkEqStmt(string l, string r) {
        var couple = new Tuple<Microsoft.Msagl.Drawing.Label,GraphAttribute>(new Microsoft.Msagl.Drawing.Label(), this.graph.Attr);
    ...
    Cell<string> MkNodeStmt(string name, ArrayList attrs) {
        ...
        var couple = new Tuple<Microsoft.Msagl.Drawing.Label,NodeAttribute>(new Microsoft.Msagl.Drawing.Label(node.Id), node.Attr);
    ...
    void MkGraphAttrStmt(ArrayList attrs) {
        var couple = new Tuple<Microsoft.Msagl.Drawing.Label,GraphAttribute>(graph.Label, graph.Attr);
        couple = AttributeValuePair.AddGraphAttrs(couple, attrs);
        graph.Label = couple.Item1;
        graph.Attribute = couple.Item2;
    }
