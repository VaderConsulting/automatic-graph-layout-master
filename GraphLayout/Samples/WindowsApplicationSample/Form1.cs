...
namespace WindowsApplicationSample {
    public partial class Form1 : Form {
        ...
        AttributeBase selectedObjectAttribute;
        ...
        void SetDragDecorator(IViewerObject obj) {
            ...
            if (dNode != null) {
                draggedObjectOriginalColors[dNode] = dNode.DrawingNode.Attribute.Color;
                dNode.DrawingNode.Attribute.Color = Color.Magenta;
        ...
        void RemoveDragDecorator(IViewerObject obj) {
            var dNode = obj as DNode;
            if (dNode != null) {
                dNode.DrawingNode.Attribute.Color = draggedObjectOriginalColors[dNode];
        ...
        void GViewerObjectUnderMouseCursorChanged(object sender, ObjectUnderMouseCursorChangedEventArgs e) {
            ...
            if (gViewer.SelectedObject == null) {
                ...
                if (edge != null) {
                   ...
                   edge.Attribute.Color = Color.Blue;
           ...
           //         here we can use e.Attr.Id or e.UserData to get back to the user data
                    ...
                    selectedObjectAttribute = (gViewer.SelectedObject as Microsoft.Msagl.Drawing.Node).Attribute.Clone();
                    (selectedObject as Microsoft.Msagl.Drawing.Node).Attribute.Color = Color.Green;
                 // //   here you can use e.Attr.Id to get back to your data
                    gViewer.SetToolTip(toolTip1,
                                       String.Format("node {0}",
                                                     (selectedObject as Microsoft.Msagl.Drawing.Node).Attribute.Id));
                    gViewer.Invalidate(e.NewObject);
                }
        ...
        void RestoreSelectedObjAttribute() {
            var edge = selectedObject as Edge;
            if (edge != null) {
                edge.Attribute = (EdgeAttribute) selectedObjectAttribute;
            }
            else {
                var node = selectedObject as Microsoft.Msagl.Drawing.Node;
                if (node != null)
                    node.Attribute = (NodeAttribute)selectedObjectAttribute;
...
*/
            ...
            //e.Attr.Weight *= wm;
            e.Attribute.Color = Color.Red;
            e.Attribute.LineWidth *= 2;
        ...
        void CreateTargetNode(Microsoft.Msagl.Drawing.Node a) {
            a.Attribute.Shape = Shape.DoubleCircle;
            a.Attribute.FillColor = Color.LightGray;
