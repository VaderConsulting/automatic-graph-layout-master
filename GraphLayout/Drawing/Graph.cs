...
namespace Microsoft.Msagl.Drawing
{
    ...
    public class Graph : DrawingObject, ILabeledObject
    {
        ...
        {
            sw.WriteLine(Attribute.ToString(Label.Text));
            WriteNodes(sw);
            WriteLayers(sw);
            WriteEdges(sw);
        }
        ...
        void InitAttributes()
        {
            ...
            //     CreateSelectedNodeAttribute();
            //     CreateSelectedEdgeAttribute();
        }
