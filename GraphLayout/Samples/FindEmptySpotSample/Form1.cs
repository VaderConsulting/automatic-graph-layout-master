...
namespace FindEmptySpotSample {
    public partial class Form1 : Form {
        ...
        object selectedObjectAttribute;
        ...
        void gViewer_ObjectUnderMouseCursorChanged(object sender, ObjectUnderMouseCursorChangedEventArgs e) {
            ...
            if (selectedObject != null) {
                if (selectedObject is Edge)
                    (selectedObject as Edge).Attribute = selectedObjectAttribute as EdgeAttribute;
                else if (selectedObject is Node)
                    (selectedObject as Node).Attribute = selectedObjectAttribute as NodeAttribute;
            ...
            if (gViewer.SelectedObject == null) {
                ...
                if (edge != null) {
                    selectedObjectAttribute = edge.Attribute.Clone();
                    edge.Attribute.Color = Microsoft.Msagl.Drawing.Color.Magenta;
                    ...
                    selectedObjectAttribute = (gViewer.SelectedObject as Node).Attribute.Clone();
                    (selectedObject as Node).Attribute.Color = Microsoft.Msagl.Drawing.Color.Magenta;
                    //here you can use e.Attr.Id to get back to your data
                    this.gViewer.SetToolTip(toolTip1, String.Format("node {0}", (selectedObject as Node).Attribute.Id));
                }
        ...
        void InsertNodeIntoGraph(Rectangle rectangle) {
            ...
            node.Attribute.FillColor=Color.Red;
            node.Attribute.Shape = Shape.DrawFromGeometry;
             node.Label=null;
            var geomNode =
        ...
        private void CreateGraph() {
            ...
            edge.LabelText = "Init";
            edge.Attribute.ArrowheadAtTarget = ArrowStyle.Tee;
            //  edge.Attr.Weight = 10;
            ...
            edge.Attribute.ArrowheadAtTarget = ArrowStyle.Tee;
            edge.Attribute.LineWidth = 10;
            edge.Attribute.Weight = 10;
            edge.Attribute.ArrowheadLength *= 2;
            edge = (Edge)graph.AddEdge("33", "T30");
            edge.Attribute.LineWidth = 15;
            edge.Attribute.AddStyle(Microsoft.Msagl.Drawing.Style.Dashed);
            graph.AddEdge("33", "34");
            graph.AddEdge("42", "4");
            graph.AddEdge("26", "4");
            graph.AddEdge("3", "4");
            ...
            edge.Attribute.ArrowheadLength *= 3;
            graph.AddEdge("20", "15");
            graph.AddEdge("28", "29");
            graph.AddEdge("6", "7");
            graph.AddEdge("15", "T1");
        ...
        private static void CreateSourceNode(Node a) {
            a.Attribute.Shape = Microsoft.Msagl.Drawing.Shape.Box;
            a.Attribute.XRadius = 3;
            a.Attribute.YRadius = 3;
            a.Attribute.FillColor = Microsoft.Msagl.Drawing.Color.Green;
            a.Attribute.LineWidth = 10;
        }

        private void CreateTargetNode(Node a) {
            a.Attribute.Shape = Microsoft.Msagl.Drawing.Shape.DoubleCircle;
            a.Attribute.FillColor = Microsoft.Msagl.Drawing.Color.LightGray;

            a.Attribute.LabelMargin = -4;
            a.UserData = this;
        }
